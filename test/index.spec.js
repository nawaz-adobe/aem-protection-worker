		...
		expect(await response.text()).toMatchInlineSnapshot(`
			...
			<html>
			  <head>
			    ...
			    <link rel="canonical" href="https://main--www--cmegroup.aem.page/education">
			    ...
			    <meta property="og:url" content="https://main--www--cmegroup.aem.page/education">
			  ...
			  <body>
			    ...
			    <main>
			      ...
			      <div>
			        ...
			        <div class="cards dynamic article">
			          <div>
			            <div>endpoint</div>
			            <div>https://www.cmegroup.com/content/cmegroup/en/misc/api/content-feeds-for-google-docs/education-home-page-follow-the-markets/jcr:content/main-content-section/section/section-elements/search_sort_filter_d.ssfajax.0.json</div>
			          </div>
			        </div>
			      </div>
			      <div>
			        ...
			        <div class="form one-click">
			          ...
			          <div>
			            <div>Source</div>
			            <div><a href="/forms/one-click-subscription/one-click-example-copy.json">https://main--www--cmegroup.aem.live/forms/one-click-subscription/one-click-example-copy.json</a></div>
			          </div>
			        </div>
			        <div class="section-metadata">
			          <div>
